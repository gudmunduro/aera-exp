...
pub fn setup_bindings_seed(system: &mut System) {
    ...
    system.models.insert(
        ...
        Mdl {
            model_id: "mdl_push".to_string(),
            left: Fact {
                pattern: MdlLeftValue::Command(Command{ name: "push".to_string(), entity_id: EntityPatternValue::EntityId("o".to_string()), params: vec![] }),
                time_range: TimePatternRange::new(TimePatternValue::Any, TimePatternValue::Any),
            },
            right: Fact {
                pattern: MdlRightValue::MkVal(MkVal {
...
pub fn setup_simple_seed(system: &mut System) {
    ...
    system.models.insert(
        ...
        Mdl {
            model_id: "mdl_move".to_string(),
            left: Fact {
                pattern: MdlLeftValue::Command(Command{ name: "move".to_string(), entity_id: EntityPatternValue::EntityId("h".to_string()), params: vec![
                    PatternItem::Binding("dp".to_string()),
                ] }),
                time_range: TimePatternRange::new(TimePatternValue::Any, TimePatternValue::Any),
            },
